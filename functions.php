...
<div class="col-sm-4 col-lg-4 col-md-4">
    <div class="thumbnail">
        <a target="_blank" href="item.php?id={$row['product_id']}" ><img width ='100' src="{$product_photo}" alt=""></a>
            <div class="caption">
               <h4> <a target="_blank" href="item.php?id={$row['product_id']}" >{$row['product_title']}</a></h4>
               <h4 class="pull-left">Rp&nbsp;{$row['product_price']}</h4>

                 </div> <a class="btn btn-primary" target="_blank" href="cart.php?add={$row['product_id']}" text-align:center>Add To Cart</a> </div>
 </div>
DELIMETER;
echo $products;
    }
...
$orders = <<< DELIMETER
    <tr>
        ...
        <td><a class = "btn btn-danger" href ="..\ktemplates\backend\delete_order.php?id={$row['order_id']}"><span class ="glyphicon glyphicon-remove"></span></a>        
        </td>
    </tr>
DELIMETER;
echo $orders;
...
$products = <<< DELIMETER
        <tr>
            ...
            <td><a href="index.php?edit_product&id={$row['product_id']}"><p>{$row['product_title']}</p></a><div><img width='100' src="../uploads/{$product_photo}" alt=""></div></td>
            <td>{$category}</td>
            <td>Rp&nbsp;{$row['product_price']}</td>
            <td>{$row['product_quantity']}</td>
            <td>
            <a class="btn btn-danger" href = "..\ktemplates\backend\delete_product.php?id={$row['product_id']}"><span class = " glyphicon glyphicon-remove"></span></a>
            </td>
       </tr>
...
<tr>
    <td>{$cat_id}</td>
    <td>{$cat_title}</td>
    <td><a class="btn btn-danger" href = "..\ktemplates\backend\delete_category.php?id={$row['cat_id']}"><span class = " glyphicon glyphicon-remove"></span></a></td>
</tr>
DELIMETER;
...
<tr>
    ...
    <td>{$username}</td>
     <td>{$email}</td>
    <td><a class="btn btn-danger" href="..\ktemplates\backend\delete_user.php?id={$row['user_id']}"><span class="glyphicon glyphicon-remove"></span></a></td>
</tr>
...
$slide_active_admin = <<<DELIMETER
    <img width='800' height='300' class="img-responsive" src="../{$slide_image}" alt="">
DELIMETER;
...
$slide_active = <<<DELIMETER
 <div class="item active">
    <img width='800' height='300' class="slide-image" src="{$slide_image}" alt="">
</div>
DELIMETER;
echo $slide_active;
    }
...
<div class="col-xs-6 col-md-3 image_container">
    ...
    <a href="index.php?delete_slide_id={$row['slide_id']}">
         ...
         <img width='800' height='300' class="img-responsive slide_image" src="../{$slide_image}" alt="">
